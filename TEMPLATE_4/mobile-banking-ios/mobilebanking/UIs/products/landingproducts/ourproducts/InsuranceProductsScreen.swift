...
struct InsuranceProductsScreen: View {
 ...
 *VIEW EXTEXTIONS*
 */
extension InsuranceProductsScreen {
    ...
    func MainContent() -> some View {
        ...
        .navigationBarTitle("Our Insurance Products",displayMode: .inline)
