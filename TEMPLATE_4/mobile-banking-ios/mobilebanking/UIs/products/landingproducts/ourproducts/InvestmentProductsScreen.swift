//
//  InvestmentProductsScreen.swift
//  mobilebanking
//
...
struct InvestmentProductsScreen: View {
 ...
 *VIEW EXTEXTIONS*
 */
extension InvestmentProductsScreen {
    ...
    func MainContent() -> some View {
        ...
        .navigationBarTitle("Our Investment Products",displayMode: .inline)
