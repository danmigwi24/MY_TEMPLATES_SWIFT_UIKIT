//
//  Step2SelfieAccountOpeningScreen.swift
//  mobilebanking
//
...
//
struct Step2SelfieAccountOpeningScreen_Previews: PreviewProvider {
    static var previews: some View {
        Step2SelfieAccountOpeningScreen()
    }
}

//
struct Step2SelfieAccountOpeningScreen: View {
 ...
 *VIEW EXTEXTIONS*
 */
extension Step2SelfieAccountOpeningScreen {
    ...
    func SetUpUI(geometry:GeometryProxy) -> some View {
        ZStack(){
            NavigationLink("", destination: Step3AccountOpeningScreen(), isActive: $navigateTo).opacity(0)
            VStack(){
                //
...
extension Step2SelfieAccountOpeningScreen{
    ...
    private func populateUserDataIfisEditing(){
        ...
        //
        print("[Step2SelfieAccountOpeningScreen ]USER DATA \(personalDetails)")
        //
