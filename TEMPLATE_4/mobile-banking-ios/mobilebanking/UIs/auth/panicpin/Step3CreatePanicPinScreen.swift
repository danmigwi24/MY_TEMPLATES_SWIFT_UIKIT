//
//  Step3CreatePanicPinScreen.swift
//  mobilebanking
//
...
struct Step3CreatePanicPinScreen: View {
 ...
 *VIEW EXTEXTIONS*
 */
extension Step3CreatePanicPinScreen {
    ...
    func SetUpUI(geometry:GeometryProxy) -> some View {
        ZStack{
            ...
            //
            NavigationLink("", destination: Step4CreatePanicPinScreen(), isActive: $navigateToConfirm).opacity(0)
            //
            VStack(spacing:10){
                ...
                //
                CustomTextBold(text: "Create new panic pin", textColor: .black, fontSize: 20, textAlignment: .center).vSpacingWithMaxWidth(.center)
                //
