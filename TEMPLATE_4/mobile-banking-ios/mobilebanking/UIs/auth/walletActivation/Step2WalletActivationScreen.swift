//
//  Step2WalletActivationScreen.swift
//  mobilebanking
//
...
struct Step2WalletActivationScreen_Previews: PreviewProvider {
    static var previews: some View {
        Step2WalletActivationScreen()
    }
}


struct Step2WalletActivationScreen: View {
    ...
    //
    @State private var firstName:String = "Dan"
    @State private var middleName:String = "Kimani"
    @State private var lastName:String = "Kim"
    @State private var idNumber:String = "33956142"
 ...
 *VIEW EXTEXTIONS*
 */
extension Step2WalletActivationScreen {
    ...
    func SetUpUI(geometry:GeometryProxy) -> some View {
        ZStack(){
            NavigationLink("", destination: Step3WalletActivationScreen(), isActive: $navigateTo).opacity(0)
            VStack(){
                //
    ...
    @ViewBuilder
    func InputFieldWithEGT() -> some View {
        VStack{
            EGTextField(text: $firstName)
                //.setTitleText("First Name")
                .setTitleColor(.black)
                .setTitleFont(.body)
                .setPlaceHolderText("First name Eg. John")
            ...
            EGTextField(text: $lastName)
                ...
                .setTitleColor(.black)
                .setTitleFont(.body)
                .setPlaceHolderText("Last name Eg. John")
                .setDisableAutoCorrection(true)
                .setPlaceHolderTextColor(Color.gray)
                .setError(errorText: $sharedViewModel.errorText, error: $errorPhoneNumber)
            
            EGTextField(text: $middleName)
                //.setTitleText("First Name")
                .setTitleColor(.black)
                .setTitleFont(.body)
                .setPlaceHolderText("Middle name Eg. John")
                .setDisableAutoCorrection(true)
                .setPlaceHolderTextColor(Color.gray)
                .setError(errorText: $sharedViewModel.errorText, error: $errorPhoneNumber)
            
            EGTextField(text: $idNumber)
                //.setTitleText("First Name")
                .setTitleColor(.black)
                .setTitleFont(.body)
                .setPlaceHolderText("ID number Eg. 12345678")
                .setDisableAutoCorrection(true)
                .setPlaceHolderTextColor(Color.gray)
                .setError(errorText: $sharedViewModel.errorText, error: $errorPhoneNumber)
...
extension Step2WalletActivationScreen{
    ...
    private func populateUserDataIfisEditing(){
        ...
        //
        print("Step2WalletActivationScreen => USER DATA \(personalDetails)")
        //
